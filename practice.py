...
def without_duplicates(words):
    ...
    for word in words: # iterating through words list with each word
        if word not in new_dictionary: # if the word is not in the new dictionary
            new_dictionary.append(word) # append the word to new dictionary
...
def find_unique_common_items(items1, items2):
    ...
    **IMPORTANT**: you may not use `'if ___ in ___``
    ...
    #create sets of items1 and items 2 to sort and remove dupes
    #find the common items using set interserction method
    #create a list with the sets using list method
